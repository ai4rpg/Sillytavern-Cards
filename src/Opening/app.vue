  ...
  <div class="character-creation-container">
    <div class="hud-block">
      ...
      <div class="intro-text">
        <p>你被古神们选中，成为能够完全免疫色情化特异点的侦探，已经有一阵子了，提尼，这个繁荣而衰败的城市总是有着数不清的麻烦，色情案件滋生在城市的每个角落，而你的任务就是纠正它们，在行动力用尽前让案件失控值归零，否则，那特异点将会入侵现实，以平然化的方式侵入人们的日常生活。</p>
        <h2>新的案件开始了……</h2>
...
const livelihoodOptions = [
  ...
  { value: '修习术法者', title: '修习术法者', description: '炼丹画符，避世清修，在特异点降临后，你发现它们与咒术同出一脉' },
...
const resistanceOptions = [
  ...
  { value: '感觉遮蔽', title: '“感觉遮蔽”', description: '你的精神完全屏蔽了性欲，无法享受快感，但肉体受到刺激的表现正常' },
...
async function handleConfirmation() {
  ...
  try {
    if (typeof Mvu === 'undefined' || typeof triggerSlash !== 'function') {
      throw new Error('无法访问酒馆助手核心API(triggerSlash)或MVU脚本。请确保酒馆助手 (Tavern Helper) 已安装并正确加载MVU。');
    }
